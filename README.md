...
Note: You cannot add spaces to the URLs.

* **Block List** <br />
Here is where you define the websites or URLs you want to block. For example, if you wish to block Reddit, just add *reddit.com*. But, if you only wanted to block part of Reddit, but not all of it you add *reddit.com/r/popular*. You can also block specific keywords that might show up in a URL. For example, if you add the word *cat*, any URLS with the word cat in it will be blocked.
